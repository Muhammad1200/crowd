...
font-size: 60px; height: 50px; color: #000000 ; margin-top : 10px; padding: 3px; padding-top: 10px; font-family: cursive; " >Thank You </h1> <h4 style="font-size: 20px; font-family: cursive; margin-left: 10px;">for the referral!</h4>
                    ...
                    <div style=" font-weight: normal; line-height: 40px;">
                        <h2 style=" color: purple; height: 50px; margin-top : 10px; padding: 3px; padding-top: 10px; font-family: cursive; " >Status : Doesn't Qualify</h2>
                    </div>
                    <div>
                        <p style="font-family: cursive ; margin-top: 14px; font-weight: 300;">
                            We appreciate the referral and after careful review ,unfortunately we can not qualify < Lead name > at this time.
                        </p>
                    </div>
                    <div style="margin-top: 20px;">
                        <p style="font-family: cursive ; margin-top: 14px; font-weight: 300;  ">
                            We have advised them to get a co-signer, pay down debt, or increase income. Additionally we added them to a long term drip campaign.
                        </p>
                    </div>
